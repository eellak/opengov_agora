...
public class ProcurementRequestServiceImplReadOnly extends DecisionGenericService<IProcurementRequest> implements IProcurementRequestService{

	private static final Logger logger = LoggerFactory.getLogger(ProcurementRequestServiceImplReadOnly.class);
