...
public class PaymentServiceImpl extends DecisionGenericService<IPayment> implements IPaymentService{
...
//		params.add(new StringSearchParameter("contract.id", contract.getId()));
////		addGetDecisionsFilters(params);
//		List<IPayment> paymentsOfContract = getAll(new PaginationInfo(), params);
//		double amount = 0.0;
//		for (IPayment payment:paymentsOfContract){
//			amount += payment.getTotalCostBeforeVat();
//		}
//		
//		return amount;
//	}
