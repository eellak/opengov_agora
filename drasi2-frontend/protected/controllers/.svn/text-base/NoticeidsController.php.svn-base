...
class NoticeidsController extends Controller
{	
	var $NoticeUrlSchema;
	var $CommonSchema;
	/**
	...
	private function processParams(){
		$this->NoticeUrlSchema  = Yii::app()->params['agora']['rfp'];
		...
		$xml->registerXPathNamespace('a',$this->NoticeUrlSchema);
