...
?>
<h1> <?php echo Yii::t('yii','Licence');?> </h1>

<div style="margin-left:10px;">
<h2>Άδεια δημόσιας χρήσης για την Ευρωπαϊκή Ένωση V.1.1</h2>
<center>EUPL © Ευρωπαϊκή Κοινότητα 2007</center>
<br/>
...
πρωτότυπο έργο:
<br/><br/>
	<center><i>Αδειοδοτείται υπό τους όρους της EUPL V.1.1</i></center>
<br/>
...
<ul style="list-style-type:square"><li>Άδεια: η παρούσα άδεια.</li>
<li>Πρωτότυπο έργο ή λογισμικό: το λογισμικό που διανέμεται ή/και παρουσιάζεται στο
κοινό από τον χορηγό της άδειας υπό τους όρους της παρούσας άδειας, το οποίο κατά
περίπτωση διατίθεται είτε ως πηγαίος κώδικας ή και ως κώδικας μηχανής.</li>
<li>Παράγωγα έργα: το έργο ή το λογισμικό που μπορούν να δημιουργηθούν από τον
...
χώρα η οποία ορίζεται στο σημείο 15.</li>
<li> Έργο: το πρωτότυπο έργο ή/και τα παράγωγα έργα του.</li>
<li>Πηγαίος κώδικας: η αναγνώσιμη για τον άνθρωπο μορφή του έργου η οποία
προσφέρεται καλύτερα για μελέτη και επεξεργασία.</li>
<li>Κώδικας μηχανής: κάθε κώδικας, ο οποίος, συνήθως μετά από διαδικασία
συμπίλησης, προορίζεται να εκτελεστεί από έναν ηλεκτρονικό υπολογιστή ως
πρόγραμμα.</li>
<li>Χορηγός της άδειας: Το φυσικό ή νομικό πρόσωπο που διανέμει ή/και παρουσιάζει
στο κοινό το έργο υπό τους όρους της άδειας.</li>
<li>Συντελεστής(ές): κάθε φυσικό ή νομικό πρόσωπο που τροποποιεί το έργο υπό τους
όρους της άδειας ή που συμβάλλει με άλλο τρόπο στη δημιουργία παράγωγου έργου.</li>
<li>Αδειούχος ή «Εσείς/Σας»: κάθε φυσικό ή νομικό πρόσωπο που κάνει οποιαδήποτε
χρήση του λογισμικού υπό τους όρους της άδειας.</li>
<li>∆ιανομή ή/και παρουσίαση στο κοινό: κάθε πράξη με την οποία πωλούνται, δίδονται,
...
δυνατότητές του σε τρίτους, φυσικά ή νομικά πρόσωπα</li>
</ul>
<br/>
<b>2. ∆ικαιώματα που παραχωρούνται με την άδεια</b>
<br/>
...
<li>να χρησιμοποιείτε το έργο σε κάθε περίσταση και για όλες τις χρήσεις,</li>
<li>να αναπαράγετε το έργο,</li>
<li>να τροποποιείτε το πρωτότυπο έργο και να δημιουργείτε παράγωγα έργα τα
οποία βασίζονται στο έργο,</li>
<li>να παρουσιάζετε το έργο στο κοινό, συμπεριλαμβανομένου του δικαιώματος
διάθεσης ή έκθεσης του έργου ή αντιγράφων του στο κοινό και να προβαίνετε,
κατά περίπτωση, σε δημόσια εκτέλεσή του,</li>
<li>να διανέμετε το έργο ή αντίγραφά του,</li>
<li>να δανείζετε και να εκμισθώνετε το έργο ή αντίγραφά του,</li>
<li>να εκχωρείτε περαιτέρω άδεια επί του έργου ή επί αντιγράφων του.</li>
</ul>
...
<b>3. Παρουσίαση του πηγαίου κώδικα στο κοινό</b>
<br/>
...
<br/><br/>
<b>4. Περιορισμοί του δικαιώματος πνευματικής ιδιοκτησίας</b>
<br/>
...
<br/><br/>
<b>5. Υποχρεώσεις του αδειούχου</b>
<br/>
...
<b>∆ικαίωμα μνείας:</b> ο αδειούχος τηρεί αμετάβλητες όλες τις ανακοινώσεις που
...
<b>Ρήτρα «Copyleft»:</b> Αν ο αδειούχος διανέμει ή/και παρουσιάζει στο κοινό αντίγραφα
...
<b>Ρήτρα συμβατότητας:</b> Αν ο αδειούχος διανέμει ή/και παρουσιάζει στο κοινό
...
<br/><br/>
<b>∆ιάθεση του πηγαίου κώδικα:</b> Όταν ο αδειούχος διανέμει ή/και παρουσιάζει στο
...
<br/><br/>
<b>Νομική προστασία:</b> Η παρούσα άδεια δεν παρέχει δικαίωμα χρήσης των εμπορικών
...
<b>9. Συμπληρωματικές συμβάσεις</b><br/>
...
<b>10. Aποδοχή των όρων της άδειας</b><br/>
...
του.
<br/><br/>
<b>11. Υποχρέωση πληροφόρησης του κοινού</b><br/>
...
<br/><br/>
<b>12. Λήξη ισχύος της άδειας</b><br/>
...
<ul style="list-style-type:square">
<li>ανακύπτει διαφορά μεταξύ της Ευρωπαϊκής Επιτροπής ως χορηγού της άδειας
και οποιουδήποτε αδειούχου,</li>
<li>ο χορηγός της άδειας, πλην της Ευρωπαϊκής Επιτροπής, δεν έχει κατοικία ή
καταστατική έδρα σε χώρα της Ευρωπαϊκής Ένωσης.</li>
</ul>
