		...
		<div class="contract" style="float:left; width:650px;">
	        ...
	        <div class="title">
		 	...
		 	<img src='images/rss-s.jpeg' align='left'/> &nbsp;  
		 			<?php echo CHtml::link(Yii::t('procurement','Procurements'),array('/procurement/rss2'),array('target'=>'blank'));		
	        		?><br/><br/>
	       <img src='images/rss-s.jpeg' align='left'/> &nbsp;
		 			<?php 
		 				  echo CHtml::link(Yii::t('rfp','RFP'),array('/rfp/rss2'),array('target'=>'blank'));		
	        		?><br/><br/>
	        <img src='images/rss-s.jpeg' align='left'/> &nbsp; 
		 			<?php 
		 				  echo CHtml::link(Yii::t('contract','Contracts'),array('/contract/rss2'),array('target'=>'blank'));		
	        		?><br/><br/>
	         <img src='images/rss-s.jpeg' align='left'/> &nbsp; 
		 			<?php 
		 				  echo CHtml::link(Yii::t('payments','Payments'),array('/payments/rss2'),array('target'=>'blank'));		
	        		?><br/><br/>
		</div><!-- contract end -->
	</div><!-- item end -->
	<div class="item">
