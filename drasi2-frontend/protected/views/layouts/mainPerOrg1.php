		...
		<div class="content-container">
			<div class="content">
				...
				<div style="margin-left:60px;">
					<img src="images/logoGR.png" style="margin-left:40px;" alt="<?php echo Yii::t('yii','Ypoyrgeio');?>" title="<?php echo Yii::t('yii','Ypoyrgeio');?>"/>
					<br/><a href="http://www.mindev.gov.gr/" target="_blank"><?php echo Yii::t('yii','Ypoyrgeio1');?><br/> <?php echo Yii::t('yii','Ypoyrgeio2');?></a>
				</div>
				...
				<?php 
					...
					if($OrgName!=''){
						...
						//echo "<div style='clear:both'></div>";
							echo"<div class='foreasName' style='width:350px;margin-top:-109px;margin-left:225px;float:left;' >";
				...
				<div class="header" style="float:left">
					<div class="logo"><a href="index.php?r=organizations/indexall">Αγορά</a></div>
						<br/>
						<div style="color: #555;font-size: 12px;margin-top: -12px;padding-left: 700px;font-style:italic;font-weight:bold">						
						<?php echo Yii::t('yii','pilot');?>
						</div>
						<div class="clear"></div> 	
						<br/>			
 				</div><!--  header end -->
				...
				<div id="mainmenu">
					...
					if( isset($org) && $org!=''){
						...
						'items'=>array(
							...
							array('label'=>'Πληροφορίες για Φορείς', 'url'=>array('/organizations/indexdetails')),
							array('label'=>'Επικοινωνία', 'url'=>array('organizations/contactus'))
