...
$this->breadcrumbs=array(
	 ...
	 Yii::t('form','Cancel') ." ".Yii::t('procurement','Procurement'),$model->title,
);
...
?>
<h1><?php echo Yii::t('form','Cancel') ." ".Yii::t('procurement','Procurement');?></h1>
...
?>
	...
	<div class="form-group">
		<fieldset>
		<legend><?php echo Yii::t('form','Cancel') ." ".Yii::t('procurement','Procurement')."-". Yii::t('form','Canceldescription');?></legend>
		<div class="row-line" >
