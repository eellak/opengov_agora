...
$this->breadcrumbs=array(
		Yii::t('payments','Payment')=>array('indexproc'), 
	 Yii::t('form','Cancel') ." ".Yii::t('payments','Payment'),$model->title,
);
...
?>
<h1><?php echo Yii::t('form','Cancel') ." ".Yii::t('payments','Payment');?></h1>
...
?>
	...
	<div class="form-group">
		<fieldset>
		<legend><?php echo Yii::t('form','Cancel') ." ".Yii::t('payments','Payment')."-". Yii::t('form','Canceldescription');?></legend>
		<div class="row-line" >
        ...
        function hpiCheck()
        {
           	var ADAVal = $('#Payments_ADACancel').val();
            <?php  echo CHtml::ajax(array(
            	  'url'=>CController::createUrl('procurement/Check'),
                  'data'=>array('ADA'=>'js:$(\'#Payments_ADACancel\').val()'),
                            'type'=>'post',
                            'dataType'=>'json',
