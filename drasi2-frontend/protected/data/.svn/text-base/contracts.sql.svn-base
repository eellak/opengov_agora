...
--
-- Table structure for table `tbl_contractitem`
--

DROP TABLE IF EXISTS `tbl_contractitem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `tbl_procurement`
--
...
CREATE TABLE `tbl_procurement` (
  ...
  `ProcurementUnit` int(11) NOT NULL,
  `ProcurementSigner` int(11) NOT NULL,
...
-- Dump completed on 2011-04-29 11:36:23
